...
paths to the QP/C framework location. These relative paths must be
modified when the project is moved to a different relative location.
...
yyy should be 0, as using the heap is not recommended.
